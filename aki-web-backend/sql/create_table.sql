...
(
    ...
    state           integer not null comment '0=new, 1=learning, 2=review, 3=relearning',
    difficuty       float not null comment  '难度',
    stability       float not null comment  '记忆稳定性',
    reps            integer not null comment '复习次数',
    lapses          integer not null,
    elapsed_days    float not null comment '过去的天数',
    scheduled_days  integer unsigned not null comment '复习间隔时间(天)',
