...
(
    ...
    difficuty       float comment  '难度',
    stability       float comment  '记忆稳定性',
    reps            integer not null default 0 comment '复习次数',
    lapses          integer,
    elapsed_days    float comment '过去的天数',
    scheduled_days  integer unsigned comment '复习间隔时间(天)',
    due             datetime comment '过期时间点',
    last_review      datetime comment '上一次复习的时间点',
